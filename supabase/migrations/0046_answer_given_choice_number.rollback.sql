-- ============================================================================
-- Rollback for 0046_answer_given_choice_number.sql
--   Restores the 0030 `ingest_persist` body (no answer_given_choice_number column
...
alter table public.responses drop column if exists answer_given_choice_number;
